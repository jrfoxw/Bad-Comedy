...
package com.example.pydev.myapplication.backend.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends JokeApiRequest<com.example.pydev.myapplication.backend.jokeApi.model.Joke> {
    ...
    protected Get(java.lang.Long id) {
      super(JokeApi.this, "GET", REST_PATH, null, com.example.pydev.myapplication.backend.jokeApi.model.Joke.class);
   ...
   *
   * @param content the {@link com.example.pydev.myapplication.backend.jokeApi.model.Joke}
   * @return the request
   */
  public Insert insert(com.example.pydev.myapplication.backend.jokeApi.model.Joke content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends JokeApiRequest<com.example.pydev.myapplication.backend.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected Insert(com.example.pydev.myapplication.backend.jokeApi.model.Joke content) {
      super(JokeApi.this, "POST", REST_PATH, content, com.example.pydev.myapplication.backend.jokeApi.model.Joke.class);
    }
  ...
  public class List extends JokeApiRequest<com.example.pydev.myapplication.backend.jokeApi.model.CollectionResponseJoke> {
     ...
     */
    protected List() {
      super(JokeApi.this, "GET", REST_PATH, null, com.example.pydev.myapplication.backend.jokeApi.model.CollectionResponseJoke.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long id, com.example.pydev.myapplication.backend.jokeApi.model.Joke content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends JokeApiRequest<com.example.pydev.myapplication.backend.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long id, com.example.pydev.myapplication.backend.jokeApi.model.Joke content) {
      super(JokeApi.this, "PATCH", REST_PATH, content, com.example.pydev.myapplication.backend.jokeApi.model.Joke.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long id, com.example.pydev.myapplication.backend.jokeApi.model.Joke content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends JokeApiRequest<com.example.pydev.myapplication.backend.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long id, com.example.pydev.myapplication.backend.jokeApi.model.Joke content) {
      super(JokeApi.this, "PUT", REST_PATH, content, com.example.pydev.myapplication.backend.jokeApi.model.Joke.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
